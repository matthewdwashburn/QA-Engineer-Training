...
Users who forgot their password must be able to securely reset it wihtout
...
FR-5: User can create a new password meeting password requirements.
...
Then the application displays a generic success message without 
...
AUTH-77-NFR-1
Password reset API responds in under 500ms (95th percentile).
