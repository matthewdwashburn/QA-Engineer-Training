...
class TestUserRepository:
    ...
    @pytest.mark.smoke
    def test_find_by_username_returns_user(self, temp_db_dsn):
        # Arrange: Create an instance of UserRepository with temporary database
        repo = UserRepository(temp_db_dsn)
    ...
    def test_find_by_username_returns_none_when_user_missing(self, temp_db_dsn):
    ...
    @pytest.mark.smoke
    def test_find_by_id_returns_user(self, temp_db_dsn):
        # Arrange: Create an instance of UserRepository
        repo = UserRepository(temp_db_dsn)
    ...
    @allure.severity(allure.severity_level.NORMAL)
    @pytest.mark.negative
    def test_find_by_id_returns_none_when_missing(self, temp_db_dsn):
        # Arrange: Create an instance of UserRepository
        repo = UserRepository(temp_db_dsn)
    ...
    @allure.severity(allure.severity_level.MINOR)
    @pytest.mark.smoke
    def test_create_user_inserts_user_and_assigns_id(self, temp_db_dsn):
        # Arrange
        repo = UserRepository(temp_db_dsn)
