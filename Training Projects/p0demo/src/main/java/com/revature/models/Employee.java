...
public class Employee {
    ...
    * If we have the entire Role object, we have access to all of that Role's data as well */
    private Role role;

    private int role_id_fk; // paired with a constructor, lets POST requests supply just the FK instead of a whole Role object
