...
**p0 Stretch Goals:** hash passwords, add REST endpoints, write unit & integration tests, output expense info to a file, put output specs in query params/headers,  user input exception handling
