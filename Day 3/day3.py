#this is global, it can be actually referenced in other modules if you import it
...
# prints Sam first because of the enclosed() method, then it prints Luke because of the local assignment
print(local_and_enclosed())
print(name)
