...
const router = createBrowserRouter([
  ...
  },
  {
    ...
    element: <ProtectedRoute authType="bearer" apiURL={MANAGER_API_URL} meRoute="/me"><ManagerDashboardPage/></ProtectedRoute>,
    errorElement: <NotFoundPage/>
  },
  {
    path: '/manager/expense-review',
    element: <ProtectedRoute authType="bearer" apiURL={MANAGER_API_URL} meRoute="/me"><ManagerExpenseReviewPage/></ProtectedRoute>,
    errorElement: <NotFoundPage/>
  },
  {
    path: '/manager/expense-report',
    element: <ProtectedRoute authType="bearer" apiURL={MANAGER_API_URL} meRoute="/me"><ManagerExpenseReportPage/></ProtectedRoute>,
    errorElement: <NotFoundPage/>
  }
])
